...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lSalidas = new javax.swing.JList<>();
        ...
        cbAlfabeto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Universal", " " }));
        ...
        lAlgoritmos.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Vigénere", "Transposición", "Telefónico" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(lAlgoritmos);

        lSalidas.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "TXT", "PDF", "XML" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane2.setViewportView(lSalidas);

        taResultados.setColumns(20);
        taResultados.setRows(5);
        jScrollPane3.setViewportView(taResultados);

        modoCodificacion.setText("Codificar/Decodificar");
    ...
    private void AceptarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarButtonActionPerformed
        ...
        for (int i : lSalidas.getSelectedIndices()) {
            salidas.add(i);
        }
    ...
    private javax.swing.JList<String> lSalidas;
